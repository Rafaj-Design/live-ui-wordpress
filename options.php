<div>
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>
						<input name="liveui_image_temp_folder" type="text" id="liveui_image_temp_folder" class="regular-text" placeholder="wp-content/cache/" value="<?php echo get_option('liveui_image_temp_folder'); ?>" /><br />
						<small<?php echo $tempImageFolderWritable ? '' : ' style="color:red;"'; ?>><?php echo ($tempImageFolderWritable ? __('Folder is writable', 'liveui') : __('Folder is NOT writable or doesn\'t exist.', 'liveui')); ?></small>
					</td>
				</tr>
				<tr>
	...
	<form method="post" action="">
		...
		<p><?php _e('LIVEUI_MISSING_TRANSLATIONS_COUNT', 'liveui') ?>: <?php echo $missingTranslationsCount; ?></p>
		<p>
